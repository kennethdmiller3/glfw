...
{
    if (window->touchCallback)
        window->touchCallback(window, touch, action);
}
...
{
    if (window->touchPosCallback)
        window->touchPosCallback(window, touch, x, y);
}
